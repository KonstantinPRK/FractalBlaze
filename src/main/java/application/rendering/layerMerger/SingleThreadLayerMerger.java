...
@Component("singleThreadLayerMerger")
public class SingleThreadLayerMerger implements LayerMerger {
    private final LayerLineMerger layerRowsMerger, layerColumnsMerger;
    private FractalImage canvas;
    private Layer mergedLayer;

    public SingleThreadLayerMerger(@Qualifier("singleThreadLayerRowsMerger") LayerLineMerger layerRowsMerger, @Qualifier("singleThreadLayerColumnsMerger") LayerLineMerger layerColumnsMerger) {
